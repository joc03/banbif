...
//
    ...
    public static Response getWithExcelSheet(String token, String casoDePrueba, String sheet) throws Throwable {
...
//
    ...
    public static Response getTotal(String token, String casoDePrueba, String sheet) throws Throwable {
        ...
        for (int i = 0; i < dato; i++) {
            ...
            response = request.get(resources);
