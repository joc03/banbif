...
public class Put {
    ...
    public static void get(String token, String baseUrl, String body, String header, String resources) {
        ...
        Response response = request.get(resources);
...
//
    ...
    public static Response getWithExcel(String token, String casoDePrueba) throws Throwable {
...
//
    ...
    public static Response putWithExcelSheet(String token, String casoDePrueba, String sheet) throws Throwable {
...
//
    ...
    public static Response putTotal(String token, String casoDePrueba, String sheet) throws Throwable {
        ...
        for (int i = 0; i < dato; i++) {
            ...
            response = request.put(resources);
