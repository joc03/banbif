...
public class Post {
    ...
    public static void post(String token,String baseUrl,String body, String header,String resources){
...
//
  ...
  public static Response postWithExcel(String token, String casoDePrueba) throws Throwable {
...
//
    ...
    public static Response postWithExcelSheet(String token, String casoDePrueba,String sheet) throws Throwable {
...
//
    ...
    public static Response postTotal(String token, String casoDePrueba,String sheet) throws Throwable {
        ...
        for (int i = 0; i < dato; i++) {
            ...
            request.header("Authorization", token);
             ...
             response = request.post(resources);
