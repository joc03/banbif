            ...
            for (int i = 1; i < nroFilas; i++) {
                ...
                for (int j = 0; j < nroColumnas; j++) {
                    ...
                    if (currentCell != null) {
                        ...
                        if (currentCell.getCellTypeEnum().equals(CellType.STRING)) {
                        ...
                        } else if (currentCell.getCellTypeEnum().equals(CellType.FORMULA)) {  //ADICION AL EXCEL
                            ...
                            switch (cellValue.getCellTypeEnum()) {
                                case BOOLEAN:
                                    System.out.println(cellValue.getBooleanValue()+" DEBES CAMBIAR FORMULA EXCEL SI QUIERES QUE RECONOZCA BOOLEANO");
                                    break;
                                case NUMERIC:
                                    double valor = currentCell.getNumericCellValue();
